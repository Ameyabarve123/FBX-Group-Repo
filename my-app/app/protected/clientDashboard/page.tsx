...
function CreateTeacherModal({ enterpriseUuid, onClose }: { enterpriseUuid: string; onClose: () => void }) {
  ...
  async function handleCreate() {
    ...
    // Save the current enterprise session — signUp auto-signs-in as the new user.
